...
resource "kubernetes_service" "app_client_service_load_balancer" {
  metadata {
    name      = "app-client-service-loadbalancer"
    namespace = var.namespace
  }
...
resource "kubernetes_service" "app_client" {
  metadata {
    name      = var.name
    namespace = var.namespace
  }
